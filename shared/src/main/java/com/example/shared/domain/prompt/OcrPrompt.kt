package com.example.shared.domain.prompt

enum class OcrPrompt(val text: String) {

    TEST_OCR_PROMPT(
        "Describe each task you see on the image " +
                "only using language you recognize on the image." +
    ...
    TEST_OCR_SYSTEM_INSTRUCTION(
        "Don't look for this image's source. " +
                "Don't recite from anywhere."
    ),
